        ...
        <div style={themeStyles}> 
            <div className="flex">
                ...
                <label className="flex  gap-2 mt-6 lg:ml-1">
                    ...
                    <input type="checkbox"
                        // checked={isdark}
                        onChange={toggleTheme} value="synthwave" className="toggle theme-controller" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
                </label>
                {/* <button
                    onClick={toggleTheme}
                    className="p-2 bg-gray-300 rounded-md text-gray-800">
                    ...
                    <div className="container p-4 mx-auto space-y-16 sm:p-10">
                        ...
                        <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center">
                                    <h4 className="text-xl font-semibold">Shahid</h4>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center">
                                    <h4 className="text-xl font-semibold">Sara Johnson</h4>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center">
                                    <h4 className="text-xl font-semibold">Tom Johnson</h4>
                                    <p className="text-sm text-gray-600">Traveller</p>
                                    <div className="flex mt-2 space-x-2">
                                        <a rel="noopener noreferrer" href="#" title="Twitter" className="text-gray-600">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="w-4 h-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center">
                                    <h4 className="text-xl font-semibold">Emila</h4>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col items-center">
                                    <h4 className="text-xl font-semibold">Jessica Smith</h4>
